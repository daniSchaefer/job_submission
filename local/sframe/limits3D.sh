...
## setup CMSSW
	...
	ls
        ...
        combine -m ${3} -M AsymptoticLimits ${2} #--run blind  new version  AsymptoticLimits --verbose 3 #--rAbsAcc 0.00001 --rRelAcc 0.00001
	#mv  higgs*.root $1/Limits/$4
	mv higgs*.root /portal/ekpbms2/home/dschaefer/DiBoson3D/limits/${4}
